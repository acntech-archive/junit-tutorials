...
public class AnnotationInjectedServiceTest {
    ...
    /**
     * The {@link org.mockito.InjectMocks} annotation identifies the class under test.
     */
    @InjectMocks
    private AnnotationInjectedService service;

    /**
     * The {@link org.mockito.Mock} annotation is used to mark classes that should be mocked by Mockito.
     */
    @Mock
