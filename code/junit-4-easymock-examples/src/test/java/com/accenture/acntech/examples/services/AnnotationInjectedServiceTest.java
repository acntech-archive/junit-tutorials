 ...
 * <li>Make JUnit run with {@link EasyMockRunner} using the {@link RunWith} annotation</li>
 * <li>No set-up method is used here as the {@link EasyMockRunner} will prepare test subject and mocks</li>
 * </ul>
 */
...
public class AnnotationInjectedServiceTest {
    ...
    /**
     * The {@link TestSubject} annotation identifies the class under test.
     */
    @TestSubject
    private AnnotationInjectedService service = new AnnotationInjectedService();

    /**
     * The {@link Mock} annotation is used to mark classes that should be mocked by EasyMock.
     */
    @Mock
